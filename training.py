...
# ----------------------------
# Training Parameters
HF_REPO_ID = "Rottenbff/EchoMind-HLRRM"
SEED = 42
NUM_EPOCHS = 2
BLOCK_SIZE = 512
BATCH_SIZE = 8
...
tags: [- hlrrin, - act, - wikitext]
metrics: [- loss, - perplexity]
---
# HLRRM-Text1

**HLRRM-Text1** is an experimental text generation model based on the **Hierarchical Long-Range Recurrent Memory (HLRRM)** architecture. It was trained from scratch on the `roneneldan/TinyStories` dataset, designed to produce simple, coherent, and child-appropriate stories.
